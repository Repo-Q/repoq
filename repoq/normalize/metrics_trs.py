...
from sympy import (
    symbols, simplify, expand, factor, collect, cancel, 
    Add, Mul, Pow, Number, Symbol, sympify, nsimplify,
    ...
    def to_canonical(self) -> str:
        ...
        if self.function_name in ('sum', 'max', 'min'):
            ...
            if self.weights is None:
                ...
                arg_strs = [f"{arg.to_canonical()}*{weight}" 
...
def optimize_metric_expression(expr: MetricExpression, 
                              optimization_level: str = 'standard') -> MetricExpression:
    """
