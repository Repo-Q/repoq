...
def simple_filter_strategy(draw):
    ...
    return draw(
        st.one_of(st.builds(dict, pattern=glob_pattern_strategy()), file_property_strategy())
    )
...
class TestFilterExpressions:
    ...
    def test_dnf_distribution(self):
        ...
        filter_dict = {
            ...
            "operands": [
                {"pattern": "*.py"},
                {"operator": "or", "operands": [{"pattern": "src/**"}, {"pattern": "test/**"}]},
            ],
        }
    ...
    def test_double_negation_elimination(self):
        ...
        filter_dict = {
            "operator": "not",
            "operands": [{"operator": "not", "operands": [{"pattern": "*.py"}]}],
        }
...
class TestAdvancedFeatures:
    ...
    def test_sympy_cnf_conversion(self):
        ...
        filter_dict = {
            ...
            "operands": [
                ...
                {"operator": "and", "operands": [{"pattern": "*.js"}, {"pattern": "test/**"}]},
            ],
        }
    ...
    def test_logical_equivalence(self):
        ...
        filter3 = {"operator": "or", "operands": [{"pattern": "*.py"}, {"pattern": "*.js"}]}
    ...
    def test_complex_real_world_filter(self):
        ...
        complex_filter = {
            ...
            "operands": [
                {
                    "operator": "or",
                    "operands": [{"pattern": "*.py"}, {"pattern": "*.js"}, {"pattern": "*.ts"}],
                },
                {
                    "operator": "not",
                    "operands": [
